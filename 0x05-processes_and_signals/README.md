...
10. Manage my process
	- [101-manage_my_process](): Bash script that indefinitely writes `Iam alive!` to the file `/tmp/my_process` and in between every `I am alive!` message, the program should pause for 2 seconds.
